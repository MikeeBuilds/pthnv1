...
type AccordionNames = 'accordion1' | 'accordion2' | 'accordion3' | 'accordion4';

const Faq = () => {
  const [isOpen, setIsOpen] = useState<Record<AccordionNames, boolean>>({
    accordion1: false,
    accordion2: false,
    accordion3: false,
    accordion4: false,
  ...
  const toggleAccordion = (accordion: AccordionNames) => {
